...
void BoundCondition_LminLMax_L0(BoundCond &cond_Lmin, BoundCond &cond_Lmax)
{
  ...
  double NoNucTime = 62.5; // first sun locdown day since Mar 23
  double NoNucIncr=3.;
      Set_sigma_SD(TDatabase::TimeDB->CURRENTTIME, NoNucTime, 15., 0.01);     
      // if(TDatabase::TimeDB->CURRENTTIME>NoNucTime)
      //  {
      //   NoNucTime +=NoNucIncr;
